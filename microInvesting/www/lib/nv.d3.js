...
//  Development render timers - disabled if dev = false
    ...
    if (nv.dev) {
        ...
        nv.dispatch.on('render_end', function (e) {
            ...
            nv.log('render total', nv.logs.totalTime); // used for development, to keep track of graph generation times

            //added by Wenjie Chen
            //notify nvd3 directive to refresh chart.
            // if check a chart refresh that chart, otherwise refresh all charts.
            var nvd3Elems = $('.click-panel');
            if (nvd3Elems.length == 0) {
                $('nvd3').not('.ng-hide').trigger('render_end');
            }
            else {
                $('.click-panel').not(".ng-hide").trigger('render_end');
            }
        });
    }
            ...
            selection.each(function (data) {
                ...
                switch (axis.orient()) {
                    case 'top':
                        ...
                        break;
                    case 'bottom':
                        // edited by wenjie chen
                        var xLabelMargin = axisLabelDistance;
                        var maxTextWidth = 30;
...
//TODO: consider deprecating by adding necessary features to multiBar model
    ...
    nv.models.discreteBarChart = function () {
        ...
        var margin = {top: 15, right: 10, bottom: 50, left: 60}
            ...
            , y
            , noData = "No Data Available."
            , dispatch = d3.dispatch('tooltipShow', 'tooltipHide', 'beforeUpdate', 'elementDblClick')
            , transitionDuration = 250
            ;
        ...
        function chart(selection) {
            selection.each(function (data) {
                ...
                discretebar.dispatch.on('elementDblClick', function (e) {
                    if (tooltips) nv.tooltip.cleanup();
                    dispatch.elementDblClick(e);
                });
    ...
    nv.models.line = function () {
        ...
        var margin = {top: 0, right: 0, bottom: 0, left: 0}
            ...
            , dispatch = d3.dispatch('elementDblClick')
            ;
    ...
    nv.models.lineChart = function () {
        ...
        function chart(selection) {
            selection.each(function (data) {
                ...
                // double click a line to filter
                //var doubleClickAreaEvent = null;
                //lines.dispatch.on('elementDblclick', function (e) {
                //    console.log(e);
                //});
                //
                //interactiveLayer.dispatch.on('elementDblclick', function (e) {
                //    var pointIndex = nv.interactiveBisect(doubleClickAreaEvent.point.values, e.pointXValue, chart.x());
                //    doubleClickAreaEvent.pointValue = doubleClickAreaEvent.point.values[pointIndex];
                //    dispatch.elementDblClick(doubleClickAreaEvent);
                //});
    ...
    nv.models.multiBar = function () {
        ...
        var margin = {top: 0, right: 0, bottom: 0, left: 0}
            ...
            , yRange
            , groupSpacing = 0.1
            , dispatch = d3.dispatch('chartClick', 'elementClick', 'elementDblClick', 'elementRightClick', 'elementMouseover', 'elementMouseout')
            ;
    ...
    nv.models.multiBarChart = function () {
        ...
        var margin = {top: 30, right: 20, bottom: 50, left: 60}
            ...
            , defaultState = null
            , noData = "No Data Available."
            , dispatch = d3.dispatch('tooltipShow', 'tooltipHide', 'stateChange', 'changeState', 'elementDblClick', 'elementRightClick')
        ...
        multibar.dispatch.on('elementDblClick', function (e) {
            if (tooltips) nv.tooltip.cleanup();
            dispatch.elementDblClick(e);
        });

        multibar.dispatch.on('elementRightClick', function (e) {
            if (tooltips) nv.tooltip.cleanup();
            dispatch.elementRightClick(e);
        });
        //============================================================
    ...
    nv.models.pieChart = function () {
        ...
        var margin = {top: 30, right: 20, bottom: 20, left: 20}
            ...
            , defaultState = null
            , noData = "No Data Available."
        //added by wenjie chen, add doubleclick call back
            , dispatch = d3.dispatch('tooltipShow', 'tooltipHide', 'stateChange', 'changeState', 'elementDblClick', 'elementRightClick')
            ;
        ...
        function chart(selection) {
            selection.each(function (data) {
                ...
                //added by wenjie chen, add doubleclick call back
                pie.dispatch.on('elementDblClick', function (e) {
                    if (tooltips) nv.tooltip.cleanup();
                    dispatch.elementDblClick(e);
                });
        ...
        //------------------------------------------------------------
        //added by wenjie chen
        pie.dispatch.on('elementRightClick', function (e) {
            if (tooltips) nv.tooltip.cleanup();
            dispatch.elementRightClick(e);
        });
    ...
    nv.models.scatter = function () {
        ...
        var margin = {top: 0, right: 0, bottom: 0, left: 0}
            ...
            , sizeRange = null
            , singlePoint = false
            , dispatch = d3.dispatch('elementClick', 'elementMouseover', 'elementMouseout', 'elementDblClick')
            , useVoronoi = true
            ;
            ...
            selection.each(function (data) {
                ...
                function updateInteractiveLayer() {
                    ...
                    if (useVoronoi === true) {
                        ...
                        pointPaths
                            .attr('d', function (d) {
                                if (!d) return; //added by wenjie chen
                                if (d.data.length === 0)
                                    return 'M 0 0'
                                else
    ...
    nv.models.scatterChart = function () {
        ...
        var margin = {top: 30, right: 20, bottom: 50, left: 75}
            ...
            , state = {}
            , defaultState = null
            , dispatch = d3.dispatch('tooltipShow', 'tooltipHide', 'stateChange', 'changeState', 'elementDblClick')
            , noData = "No Data Available."
            , transitionDuration = 250
            ;
        ...
        function chart(selection) {
            selection.each(function (data) {
                ...
                scatter.dispatch.on('elementDblClick', function (e) {
                    if (tooltips) nv.tooltip.cleanup();
                    dispatch.elementDblClick(e);
                });
    ...
    nv.models.stackedArea = function () {
        ...
        var margin = {top: 0, right: 0, bottom: 0, left: 0}
            ...
            , dispatch = d3.dispatch('tooltipShow', 'tooltipHide', 'areaClick', 'elementDblClick', 'areaMouseover', 'areaMouseout')
            ;
